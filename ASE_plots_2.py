...
def cis_vs_trans(parental_file,hybrid_file,exp_file,indices):
    ...
    ##print binned_cis_vals

    for cur_x,cur_bin in zip(binned_cis_vals,range(BINS)):
...
def calc_trans(parental_file,hybrid_file,outfile):
...
calc_trans('PAXB_RABS_expDiff.l','loose_PAXB_VTP_ASE.l','PAXB_RABS_transDiff.l')
calc_trans('CERC_RABS_expDiff.l','CERC_VTP_ASE.l','CERC_RABS_transDiff.l')
